@include ('header', ['title' => $name .' | triplaxis'])
@include ('navigation')
<h1>{{ $name }}</h1>
      <div class="media">
        <div class="">
		<img class="align-self-start mr-3" alt="" width="750px" height="600px">
		<div>
			<img class="align-self-start mr-3" alt="" width="110px" height="110px">
			<img class="align-self-start mr-3" alt="" width="110px" height="110px">
			<img class="align-self-start mr-3" alt="" width="110px" height="110px">
		...
		@include ('fillament', ['color' => [ 'PLAwood.png', 'PLAflex.png',  'PLAglow.png' ]])</div>
          ...
          <div class="input-group mb-3">
            <div style="display: flex">
              ...
              <input style=" width:3em" value="1" name="quantity" disabled id="number" type="text" class="form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
	...
	<input type="hidden" id="base-price" />
      ...
      </div><!-- closing for media-body !-->
      </div><!-- closing for media !-->
